...
Route::group(['prefix' => 'admin'], function() {
	...
	Route::get('user-demo', 'Admin\SiteController@userDemo');
	Route::get('user-behaviors', 'Admin\SiteController@userBehaviors');
	Route::get('setting', 'Admin\SiteController@setting');
});
